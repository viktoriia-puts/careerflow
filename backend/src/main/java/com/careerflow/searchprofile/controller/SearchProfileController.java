...
public class SearchProfileController {
    ...
    @GetMapping
    public ResponseEntity<List<SearchProfileResponse>> getSearchProfiles() {
        return ResponseEntity.ok(searchProfileService.getSearchProfiles());
    }

    @GetMapping("/{id}")
    public ResponseEntity<SearchProfileResponse> getSearchProfile(@PathVariable Long id) {
        return ResponseEntity.ok(searchProfileService.getSearchProfile(id));
    }
